...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese las coordenadas de la siguiente manera: x1,y1,x2,y2");
        p1.CrearPuntos(leer.nextInt(), leer.nextInt(), leer.nextInt(), leer.nextInt());
        System.out.println("La distancia:" + p1.CalcularDistancia());
